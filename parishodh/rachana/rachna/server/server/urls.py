...
urlpatterns = patterns('',
    ...
    url(r'^project_details$', 'server.views.project_details', name='postdetails'),
    url(r'^post_comment$', 'server.views.post_comment', name='postcoomet'),
    url(r'^like$', 'server.views.doLike', name='dl'),
    url(r'^bangalore$', 'server.views.bangalore', name='bangalore'),
    url(r'^index2$', 'server.views.index2', name='index2'),
