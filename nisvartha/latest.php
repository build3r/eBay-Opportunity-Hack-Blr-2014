...
// Success URL
$surl = "http://localhost:91/nisvarth/paymentsuccess.php";

// failure URL
$furl = "http://localhost:91/nisvarth/paymenterror.php";
	...
	$.ajax(
			{
				type: 'post',
				url: "do_donate.php",
				data: { fname: $('#firstname').val(),lname: $('#lastname').val(),email: $('#email').val(),mobile: $('#phone').val(),address: $('#address1').val(),city: $('#city').val(),state: $('#ddlstate').val(),country: $('#ddlcountry').val(), pincode:$('#zipcode').val(), amount:$('#amount').val()},
        ...
        <div id="content_Container">
            ...
            <div id="navigation_wrapper">
                ...
                <ul class="main_nav">
                    ...
                    <li><a href='students.php'>Login</a></li>
                </ul>
            </div>
                ...
                <table width="657" border="0" cellspacing="0" cellpadding="0" class="donate">
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td> 
							<input name="phone" id="phone" value="<?php echo (empty($posted['phone'])) ? '' : $posted['phone']; ?>" maxlength="32" size="34"/>							
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
							<input name="address1" id="address1" value="<?php echo (empty($posted['address1'])) ? '' : $posted['address1']; ?>" maxlength="64" size="34"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
							<input name="city" id="city" value="<?php echo (empty($posted['city'])) ? '' : $posted['city']; ?>" size="34" maxlength="32"/>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
							<input name="zipcode" id="zipcode" value="<?php echo (empty($posted['zipcode'])) ? '' : $posted['zipcode']; ?>" size="34" maxlength="10" />
                        </td>
					...
					<tr>
                        ...
                        <td>
							<input name="amount" id="amount" value="<?php echo (empty($posted['amount'])) ? '' : $posted['amount'] ?>" size="34" maxlength="10" />
                        </td>
