...
<form action="studentformeditcode.php" method="post">
  <table>
   ...
   <tr><td>*Address</td><td><textarea rows="10" cols="30" name="addr"><?php echo($row['addr']);?></textarea></td></tr>
   <tr><td>*Standard</td><td><input list="std11" name="std1" value=<?php echo($row['std1']);?>><datalist id="std11" ><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></datalist></td></tr>
   <tr><td>&nbspSchool</td><td><input type="text" name="schl" value=<?php echo($row['schl']);?>></td></tr>
   <tr><td>&nbspInterests</td><td><textarea rows="5" cols="20" name="intrs"><?php echo($row['intrs']);?></textarea></td></tr>
   ...
   <tr><td>If yes details</td><td><textarea rows="10" cols="30" name="pcdt"><?php echo($row['pcdt']);?></textarea></td></tr>
