...
<form action="volunteerformeditcode.php" method="post">
<table>
...
<tr><td>*Permanent Address</td><td><textarea rows="5" cols="30" name="paddv" ><?php echo($row['paddv']);?></textarea></td></tr>
<tr><td>&nbspCurrent Address</td><td><textarea rows="5" cols="30" name="caddv" ><?php echo($row['caddv']);?></textarea></td></tr>
<tr><td>*Languages Known</td><td><textarea rows="5" cols="30" name="langv" ><?php echo($row['langv']);?></textarea></td></tr>
...
<tr><td>&nbspCurrent Sessions</td><td><textarea rows="5" cols="20" name="cursv" ><?php echo($row['cursv']);?></textarea></td></tr>
<tr><td>&nbspExperienced Sessions</td><td><textarea rows="5" cols="20" name="expsv"><?php echo($row['expsv']);?></textarea></td></tr>
