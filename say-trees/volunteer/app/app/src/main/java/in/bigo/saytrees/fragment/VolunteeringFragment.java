...
public class VolunteeringFragment extends Fragment implements View.OnClickListener, EndlessListView.EndLessListener {
    ...
    private String TAG = VolunteeringFragment.class.toString();
     ...
     */
    public static VolunteeringFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_volunteerting, container, false);
        initUI();
